...
def process_config():
        ...
        data_arg.add_argument('--data_dir', type=str, default='/home/ruby/Desktop/Git/nea/data')
        ...
        #data_arg.add_argument('--corpus_target', type=str, default="/home/ruby/Desktop/Git/nea/data")  # asap, reada, gcdc, toefl  ## given by path if it is empty
        data_arg.add_argument('--corpus_target', type=str, default="asap")  # asap, reada, gcdc, toefl  ## given by path if it is empty
        ...
        misc_arg.add_argument('--use_gpu', type=str2bool, default=False)  # automatically assigned
        ...
        misc_arg.add_argument('--device', type=str, default="cpu")  # automatically assigned
